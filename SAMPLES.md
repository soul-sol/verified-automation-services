...
| [CI first 15 minutes](samples/ci-first-15-minutes.md) | A GitHub Actions run fails and the cause is unclear | [Request CI diagnosis](https://github.com/soul-sol/verified-automation-services/issues/new?template=ci-triage.yml) |
...
| [Go cross-architecture workflow](samples/go-cross-architecture.yml) | A Go project needs compile and test coverage across Linux architectures | [Ask about the full starter kit](https://github.com/soul-sol/verified-automation-services/issues/new?template=digital-kit.yml) |
